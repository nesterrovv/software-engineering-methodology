...
public class HallMonitoringService {
    ...
    private ContactMonitoringService contactMonitoringService;
    ...
    public HallStatusResponse getCurrentHallStatus() {
        ...
        List<HallStatusResponse.ZoneActivity> zones = Arrays.asList(
            new HallStatusResponse.ZoneActivity("Игровой зал, столы 1-5", 15, 2, "NORMAL"),
            new HallStatusResponse.ZoneActivity("Игровой зал, столы 6-10", 20, 3, "HIGH_ACTIVITY"),
            new HallStatusResponse.ZoneActivity("Игровой зал, столы 11-15", 12, 2, "NORMAL"),
            new HallStatusResponse.ZoneActivity("Барная зона", 8, 1, "NORMAL"),
            new HallStatusResponse.ZoneActivity("Входная зона", 10, 2, suspiciousContacts > 0 ? "ANOMALY" : "NORMAL")
        );
